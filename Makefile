...
$(vmlinux): $(linux_srcdir) $(linux_wrkdir)/.config $(buildroot_initramfs_sysroot_stamp) /local/scratch/jrrk2/freedom-u-sdk/work/initramfs.cpio
	$(MAKE) -C $< O=$(linux_wrkdir) -j 4 \
		CONFIG_INITRAMFS_SOURCE="/local/scratch/jrrk2/freedom-u-sdk/work/initramfs.cpio" \
